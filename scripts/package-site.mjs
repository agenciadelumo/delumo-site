...
const legacyDirectories = ['assets', 'aprender', 'blog', 'bora', 'cases', 'convite', 'erechim', 'imersao', 'propostadayro', 'redelius', 'propostacastelinho', 'propostaerbs', 'propostaerbsrh', 'propostav3t', 'propostavandanamotos', 'servicos', 'aratiba_taverna'];
...
for (const route of ['propostadayro/index.html', 'redelius/index.html', 'propostacastelinho/index.html', 'propostaerbs/index.html', 'propostaerbsrh/index.html', 'convite/index.html', 'erechim/index.html', 'imersao/index.html', 'index.html']) {
