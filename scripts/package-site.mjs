...
const legacyDirectories = ['assets', 'aprender', 'blog', 'bora', 'cases', 'convite', 'erechim', 'imersao', 'propostadayro', 'propostacastelinho', 'propostaerbs', 'propostav3t', 'propostavandanamotos', 'servicos', 'aratiba_taverna'];
...
for (const route of ['propostadayro/index.html', 'propostacastelinho/index.html', 'propostaerbs/index.html', 'convite/index.html', 'erechim/index.html', 'imersao/index.html', 'index.html']) {
