...
5. Validar gravação real, recarregar em um segundo navegador/aparelho, testar conflito de duas sessões, histórico no banco e rejeição de acesso sem sessão. A preparação local não comprova essa ativação.
