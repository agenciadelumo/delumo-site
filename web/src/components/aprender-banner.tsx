...
export function AprenderBanner() {
  return <section className="aprender-band" aria-labelledby="aprender-title"><div className="container">
    <div className="aprender-band-heading"><div><p className="eyebrow">CONHECIMENTO COM DIREÇÃO</p><h2 id="aprender-title">Delumo Aprender</h2><p>Sua próxima experiência de aprendizagem começa com uma conversa.</p></div><a href="/aprender" className="aprender-band-action">Planejar um treinamento <ArrowUpRight size={20}/></a></div>
